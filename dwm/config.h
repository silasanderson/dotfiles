...
static const char *fonts[]          = { "JetBrains Mono Medium:pixelsize=12:antialias=true:autohint=true", "JoyPixels:pixelsize=10:antialias=true:autohint=true"  };
static char dmenufont[]             = { "JetBrains Mono Medium:pixelsize=12:antialias=true:autohint=true" };
